...
HeapWord* G1CollectedHeap::do_collection_pause(size_t word_size,
  ...
  *succeeded = ret_succeeded;
  ...
  // Add counting code here
  size_t young_objects = 0;
  size_t young_bytes = 0;
  ...
  log_info(gc)("Young Region - Objects: %zu, Bytes: %zu", young_objects, young_bytes);
  log_info(gc)("Old Region - Objects: %zu, Bytes: %zu", old_objects, old_bytes);
